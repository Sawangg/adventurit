...
export type MainMenuLoginProps = React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement> & {
  dictionnary: Dictionnary;
};

export const MainMenuLogin: React.FC = () => {
  return (
    <div className="absolute inset-0 flex size-full flex-col items-center justify-center gap-y-7 bg-black/50 text-white backdrop-blur-sm">
